#!/usr/bin/env sh
# Universal installer for honeypot-mil. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/honeypot-mil.git"
echo "Installing honeypot-mil ..."
...
echo "Done. Run: honeypot-mil --help"
